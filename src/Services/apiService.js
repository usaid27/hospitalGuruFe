...
export const logout = async () => {
    try {
        await axios.post(`${AUTH_API_URL}logout`, {}, { headers: getAuthHeaders() });
...
export const upserthospital = async (hospitalData) => {
    try {
        ...
        const response = await axios.post(`${APP_API_URL}UpsertHospitalDetails`, hospitalData, {
            headers: {
                'Content-Type': 'multipart/form-data',
...
export const deleteHospital = async (id) => {
    try {
        const response = await axios.post(`${APP_API_URL}DeleteHospital/${id}`, null, {
            headers: getAuthHeaders(),
        });
        return response.data;
    } catch (error) {
...
export const upsertProcedure = async (procedureData) => {
    try {
        ...
        const response = await axios.post(`${APP_API_URL}UpsertProceduresDetails`, procedureData, {
            headers: {
                'Content-Type': 'multipart/form-data',
                ...getAuthHeaders(), // Include the token in the headers if needed
            },
...
export const deleteProcedure = async (id) => {
    try {
        const response = await axios.post(`${APP_API_URL}DeleteProcedure/${id}`, null, {
            headers: getAuthHeaders(),
        });
        return response.data;
    } catch (error) {
