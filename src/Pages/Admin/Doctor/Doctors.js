      ...
      Cell: ({ row }) => {
        ...
        return (
          <div className="action-buttons" style={{ textAlign: 'center' }}>
            <Button variant="info" size="sm" onClick={() => handleViewDoctor(doctor)} style={{ margin: '0 2px' }}>
              <FaEye />
            </Button>
            <Button variant="warning" size="sm" onClick={() => navigate(`/admin/doctors/edit-doctor/${doctor.id}`)} style={{ margin: '0 2px' }}>
              <FaEdit />
            </Button>
            <Button variant="danger" size="sm" onClick={() => handleDelete(doctor.id)} style={{ margin: '0 2px' }}>
              <FaTrash />
            </Button>
