...
function Procedures() {
          ...
          return (
            <div className="action-buttons" style={{ textAlign: "center" }}>
              ...
              <Button
                ...
                size="sm"
                onClick={() =>
                  navigate(`/admin/procedures/edit-procedure/${procedure.id}`)
                }
                style={{ margin: "0 2px" }}
              >
                <FaEdit />
              ...
              {procedure.socialLinks && procedure.socialLinks.fbLink && (
                <Button
                  ...
                  size="sm"
                  onClick={() =>
                    window.open(procedure.socialLinks.fbLink, "_blank")
                  }
                  style={{ margin: "0 2px" }}
                >
              ...
              {procedure.socialLinks && procedure.socialLinks.linkedInLink && (
                <Button
                  ...
                  size="sm"
                  onClick={() =>
                    window.open(procedure.socialLinks.linkedInLink, "_blank")
                  }
                  style={{ margin: "0 2px" }}
                >
              ...
              {procedure.socialLinks && procedure.socialLinks.xLink && (
                <Button
                  ...
                  size="sm"
                  onClick={() =>
                    window.open(procedure.socialLinks.xLink, "_blank")
                  }
                  style={{ margin: "0 2px" }}
                >
              ...
              {procedure.socialLinks && procedure.socialLinks.threadLink && (
                <Button
                  ...
                  size="sm"
                  onClick={() =>
                    window.open(procedure.socialLinks.threadLink, "_blank")
                  }
                  style={{ margin: "0 2px" }}
                >
    ...
    return procedures.filter(
      (procedure) =>
        ...
        (procedure.successRate &&
          procedure.successRate.toString().includes(searchText)) ||
        (procedure.causes &&
          procedure.causes.toLowerCase().includes(searchText.toLowerCase())) ||
        (procedure.symptoms &&
          procedure.symptoms
            .toLowerCase()
            .includes(searchText.toLowerCase())) ||
  ...
  const currentProcedures = useMemo(() => {
    return rows
      .slice(indexOfFirstProcedure, indexOfLastProcedure)
      .map((row) => {
        prepareRow(row);
        return row.original;
      });
    ...
    <Container fluid>
      <Row className="mb-3 mt-3">
        <Col xs={12} md={3} className="mb-2 mb-md-0">
          <Button
            variant="primary"
            onClick={() => navigate("/admin/procedures/add-procedure")}
          >
              ...
              {currentProcedures.length > 0 ? (
                currentProcedures.map((procedure) => (
                  <tr key={procedure.id}>
                    ...
                    <td>
                      <img
                        src={convertByteArrayToImage(
                          procedure.introductionMedia
                        )}
                        alt="Procedure"
                        style={{
                          width: "50px",
                    ...
                    <td>
                      ...
                      >
                        ...
                        <Button
                          ...
                          onClick={() =>
                            navigate(
                              `/admin/procedures/edit-procedure/${procedure.id}`
                            )
                          }
                          style={{ margin: "0 2px" }}
                        >
                        ...
                        {/* Add social media buttons */}
                        {procedure.socialLinks &&
                          procedure.socialLinks.fbLink && (
                            <Button
                              variant="primary"
                              size="sm"
                              onClick={() =>
                        ...
                        {procedure.socialLinks &&
                          procedure.socialLinks.linkedInLink && (
                            <Button
                              variant="info"
                              size="sm"
                              onClick={() =>
                        ...
                        {procedure.socialLinks &&
                          procedure.socialLinks.threadLink && (
                            <Button
                              variant="dark"
                              size="sm"
                              onClick={() =>
      ...
      <Row className="align-items-center mt-3">
        <Col md={6}>
          <div className="d-flex align-items-center">
            ...
            <span>
              Showing {indexOfFirstProcedure + 1} to{" "}
              {Math.min(indexOfLastProcedure, filteredData.length)} of{" "}
              {filteredData.length} procedures
            </span>
          </div>
        </Col>
